 ...
 */
 ...
 //        toolbar.add(btn_next);
		 ...
		 btn_start_terminal.icon_widget = get_shared_icon("utilities-terminal","utilities-terminal.png",24);
		 ...
		 btn_generate_preview.icon_widget = get_shared_icon("gtk-missing-image","image-generate24x24.png",24);
