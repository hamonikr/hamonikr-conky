...
echo '${goto 270}''${font mono:bold:size=11.5}'$TOPLINE | sed 's/Su/${color red}Su${color}/g' | sed 's/Sa/${color red}Sa${color}/g'
echo '${goto 270}''${font mono:bold:size=11.5}''${color C28C3A}'$OVER '${color 5BED1B}'$TODAY'${color}'$REST
